public class Program
{
    static void Main(string[] args)
    {
        ...
        //Propability
        double p1 = (1.0f / (1.0f + Math.Pow(10, ((player_1_score - player_2_score) / 400)))) / amountOfGamesPlayed; //400 * wins - losses = 400 * 1
        double p2 = (1.0f / (1.0f + Math.Pow(10, ((player_2_score - player_1_score) / 400)))) / amountOfGamesPlayed; //400 * wins - losses = 400 * 1
        ...
        //Player 1 win test
        player_1_score += k * (1 - (float)p2); //1 win - 0 losses = 1
        player_2_score += k * ((float)p2 - 1); //0 wins - 1 losses = -1
